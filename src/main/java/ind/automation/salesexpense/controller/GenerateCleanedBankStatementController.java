...
public class GenerateCleanedBankStatementController {
	...
	public ResponseEntity<BankStatementResponseBean> generateCleanedBankStatement(@RequestPart("file") MultipartFile file,
