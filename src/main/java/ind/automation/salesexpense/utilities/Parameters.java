...
public class Parameters {
	...
	public String getCheckCard() {
		String checkCard;
		checkCard = ((String) param.get("expense.checkcard"));
		return checkCard;
	}
	...
	@SuppressWarnings("unchecked")
	public ArrayList<String> getSalesKeywords() {
		ArrayList<String> salesKeywords;
		salesKeywords = ((ArrayList<String>) param.get("sales.keywords"));
		return salesKeywords;
	}
}
