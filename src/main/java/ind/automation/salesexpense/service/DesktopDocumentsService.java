...
public interface DesktopDocumentsService {
	FullVendorListResponseBean modifyDesktopBalanceSheet(MultipartFile balanceSheetFile, MultipartFile accountListFile)
			throws EncryptedDocumentException, InvalidFormatException, IOException;

	FullVendorListResponseBean createVendorList(String balanceSheetFileName, AccountList accountListBean)
			throws FileNotFoundException, IOException;

	AccountList getDesktopAccountList(MultipartFile accountListFile) throws IOException;
}
